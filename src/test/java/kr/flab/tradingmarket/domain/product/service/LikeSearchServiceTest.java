...
class LikeSearchServiceTest {
    ...
    @InjectMocks
    LikeSearchService likeSearchService;
    ...
    void successfulSearchByPopular() {
        //given
        given(productMapper.findByProductsWithLikeSearch(any(), any()))
            .willReturn(DEFAULT_FIND_SEARCH_PRODUCT_LIST);

        //when
        ResponseProductSimpleDto search = likeSearchService.search(DEFAULT_PAGE_POPULAR_PRODUCT_SEARCH_DTO, 1L);

        //then
        then(productMapper).should().findByProductsWithLikeSearch(any(), any());
    ...
    void successfulSearchByDate() {
        ...
        //when
        ResponseProductSimpleDto search = likeSearchService.search(DEFAULT_PAGE_DATE_PRODUCT_SEARCH_DTO, 1L);
    ...
    void successfulSearchByPriceDesc() {
        ...
        //when
        ResponseProductSimpleDto search = likeSearchService.search(DEFAULT_PAGE_PRICE_DESC_PRODUCT_SEARCH_DTO, 1L);
    ...
    void successfulSearchByPriceAsc() {
        ...
        //when
        ResponseProductSimpleDto search = likeSearchService.search(DEFAULT_PAGE_PRICE_ASC_PRODUCT_SEARCH_DTO, 1L);
